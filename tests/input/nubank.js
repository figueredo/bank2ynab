...
import mapFactory from '../../src/input/nubank';
...
test('returns the entry when the date is invalid', (t) => {
  const entry = '04 MON THE WORTHY CARRIAGE NANO STORE	6,49'; // eslint-disable-line no-tabs
  const expectedOutput = '04 MON THE WORTHY CARRIAGE NANO STORE	6,49'; // eslint-disable-line no-tabs
...
test('uses defined year when parsing statement date', (t) => {
  const entry = '04 JUN THE WORTHY CARRIAGE NANO STORE	6,49'; // eslint-disable-line no-tabs
